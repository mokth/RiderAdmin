...
export class AuthService {
    ...
    logIn(name: string, password: string) {
        ...
        console.log('posting login' + this.apiUrl + 'auth/jwt1');
        this.http.post(this.apiUrl + 'auth/jwt1',
    ...
    requestAccess(screenid: string) {
        ...
        return this.http.post(this.apiUrl + 'auth/access',
            body, { headers: headers });
    }
    ...
    changePassword(user: UserInfo): Observable<any> {
        ...
        let headers = new HttpHeaders();
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.apiUrl + 'auth/change',
            body, { headers: headers });
    }
    ...
    resetPassword(userid: string): Observable<any> {
        let headers = new HttpHeaders();
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.apiUrl + 'auth/reset/' + userid,
            { headers: headers });
    }
    ...
    getAppMenu(){
        let headers = new HttpHeaders();
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.apiUrl + 'auth/menu/',
            { headers: headers });
    }
}
